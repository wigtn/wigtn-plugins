...
**Used to win Grand Prize at [Build with TRAE Seoul (ByteDance)](https://trae.ai)** — built a multi-agent debate arena in 3.5 hours using PRD generated by this plugin.
...
| **WigtnOCR** | #1 on KoGovDoc benchmark |
