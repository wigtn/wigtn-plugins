...
![Version](https://img.shields.io/badge/v0.1.7-Unified_Plugin-FF6B6B?style=for-the-badge)
...
| `/screen-spec <기능>` | 선택적 UI 게이트: IA + 유저 플로우 + 화면별 명세 + 클릭 가능한 HTML 와이어프레임 + Dev Handoff. design-discovery 20종 스타일과 연동 |
...
| `screen-spec` | PRD로부터 5종 UI 산출물 생성 — IA, User Flow, 화면별 명세, 클릭 가능한 Wireframe HTML, Dev Handoff. 20개 디자인 스타일 연동. `/screen-spec`에서 호출 |
